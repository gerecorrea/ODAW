  ...
  <style>
    ...
    * {
    ...
    .botao:hover{/*altera cor dos botões ao passar por ele*/
      ...
      background-color: rgba(184, 140, 12, 0.5);
  ...
  <nav class="navmenu">
    ...
    <article class="articlePagina3">
      <?php
        ...
        $query = "SELECT * FROM filme ORDER BY titulo";
        $result = mysqli_query($link, $query);
        
        echo "<h1><center> Listagem de filmes <center></h1><br><br>";

        // echo "<br><br><a href='ExtraPages/FilmesMaisFavoritados.php' class='card-foot botao' style='color: #000'>Filmes mais favoritados</a>";
        // echo "<a href='ExtraPages/FilmesMaisLongos.php' class='card-foot botao' style='color: #000'>Filmes mais longos</a>";
        // echo "<a href='ExtraPages/FilmesOrdemLancamento.php' class='card-foot botao' style='color: #000'>Filmes mais recentes</a><br><br>";

        // echo "<br><br><br><br><br><h4>Filmes por gênero</h2><br>";
        // echo "<a href='ExtraPages/FilmesAcao.php' class='card-foot botao' style='color: #000'>Ação</a>";
        // echo "<a href='ExtraPages/FilmesAventura.php' class='card-foot botao' style='color: #000'>Aventura</a>";
        // echo "<a href='ExtraPages/FilmesComedia.php' class='card-foot botao' style='color: #000'>Comédia</a>";
        // echo "<a href='ExtraPages/FilmesFantasia.php' class='card-foot botao' style='color: #000'>Fantasia</a>";
        // echo "<a href='ExtraPages/FilmesFiccaoCientifica.php' class='card-foot botao' style='color: #000'>Ficção Científica</a>";
        // echo "<a href='ExtraPages/FilmesRomance.php' class='card-foot botao' style='color: #000'>Romance</a>";
        // echo "<a href='ExtraPages/FilmesTerror.php' class='card-foot botao' style='color: #000'>Terror</a>";
        // echo "<a href='ExtraPages/FilmesThriller.php' class='card-foot botao' style='color: #000'>Thriller</a>";
